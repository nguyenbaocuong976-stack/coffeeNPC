...
function showNotification(message, type) {
    ...
    notification.className = `app-notification fixed bottom-5 right-5 mt-3 p-4 rounded-lg shadow-xl text-white z-[1002] transition-transform duration-500 ease-out transform translate-x-full ${type === 'success' ? 'bg-green-600' : type === 'error' ? 'bg-red-600' : 'bg-blue-600'}`;
    ...
    if (container) {
        ...
        newContainer.className = 'fixed bottom-5 right-5 z-[1002]';
